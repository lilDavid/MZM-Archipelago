...
const u16* const sJapaneseTextPointers_Message[MESSAGE_END] = {
    ...
    [MESSAGE_NOTHING_ACQUIRED] = sJapaneseText_Message_NothingAcquired,
    [MESSAGE_SPAZER_BEAM] = sJapaneseText_Message_SpazerBeam,
    [MESSAGE_GRAPPLE_BEAM] = sJapaneseText_Message_GrappleBeam,
    [MESSAGE_SPRING_BALL] = sJapaneseText_Message_SpringBall,
    [MESSAGE_XRAY_SCOPE] = sJapaneseText_Message_XRayScope,
    [MESSAGE_RESERVE_TANK] = sJapaneseText_Message_ReserveTank,
    [MESSAGE_WALL_JUMP] = sJapaneseText_Message_WallJump,
    [MESSAGE_POWER_BEAM] = sJapaneseText_Message_PowerBeam,
    [MESSAGE_SPIDER_BALL] = sJapaneseText_Message_SpiderBall,
...
const u16* const sHiraganaTextPointers_Message[MESSAGE_END] = {
    ...
    [MESSAGE_SPAZER_BEAM] = sHiraganaText_Message_SpazerBeam,
    [MESSAGE_GRAPPLE_BEAM] = sHiraganaText_Message_GrappleBeam,
    [MESSAGE_SPRING_BALL] = sHiraganaText_Message_SpringBall,
    [MESSAGE_XRAY_SCOPE] = sHiraganaText_Message_XRayScope,
    [MESSAGE_RESERVE_TANK] = sHiraganaText_Message_ReserveTank,
    [MESSAGE_WALL_JUMP] = sHiraganaText_Message_WallJump,
    [MESSAGE_POWER_BEAM] = sHiraganaText_Message_PowerBeam,
    [MESSAGE_SPIDER_BALL] = sHiraganaText_Message_SpiderBall,
    [MESSAGE_NOTHING_ACQUIRED] = sHiraganaText_Message_NothingAcquired,
...
const u16* const sEnglishTextPointers_Message[MESSAGE_END] = {
    ...
    [MESSAGE_NOTHING_ACQUIRED] = sEnglishText_Message_NothingAcquired,
    [MESSAGE_SPAZER_BEAM] = sEnglishText_Message_SpazerBeam,
    [MESSAGE_GRAPPLE_BEAM] = sEnglishText_Message_GrappleBeam,
    [MESSAGE_SPRING_BALL] = sEnglishText_Message_SpringBall,
    [MESSAGE_XRAY_SCOPE] = sEnglishText_Message_XRayScope,
    [MESSAGE_RESERVE_TANK] = sEnglishText_Message_ReserveTank,
    [MESSAGE_WALL_JUMP] = sEnglishText_Message_WallJump,
    [MESSAGE_POWER_BEAM] = sEnglishText_Message_PowerBeam,
    [MESSAGE_SPIDER_BALL] = sEnglishText_Message_SpiderBall,
