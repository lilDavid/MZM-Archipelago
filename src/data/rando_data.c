...
const u16 sRandoItemAcquisitionSfx[MESSAGE_DYNAMIC_ITEM] = {
    ...
    [MESSAGE_ENERGY_TANK_ACQUIRED] = 0x87,  // Large energy drop pickup
    ...
    [MESSAGE_LONG_BEAM] = 0xC9,  // Firing pure Long Beam
    [MESSAGE_CHARGE_BEAM] = 0xF0, // Firing charged short Power Beam
    [MESSAGE_ICE_BEAM] = 0xCA,  // Firing pure Ice Beam
    [MESSAGE_WAVE_BEAM] = 0xCC,  // Firing pure Wave Beam
    [MESSAGE_UKNOWN_ITEM_PLASMA] = 0xD0,  // Firing pure Plasma Beam
    [MESSAGE_BOMB] = 0xFF,  // Bomb exploding
    ...
    [MESSAGE_PLASMA_BEAM] = 0xD0,  // Firing pure Plasma Beam
