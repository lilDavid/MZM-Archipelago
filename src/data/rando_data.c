...
const u8 sRoomItemsCrateria[] = {
     5, RC_CRATERIA_LANDING_SITE_BALLSPARK, // TODO: Fake landing site ballspark scout
     7, RC_CRATERIA_MOAT,
...
const u8 sRoomItemsChozodia[] = {
    ...
    90, RC_CHOZODIA_CHOZO_GHOST_AREA_UNDERWATER, // TODO: Fake Charlie spark super scout
