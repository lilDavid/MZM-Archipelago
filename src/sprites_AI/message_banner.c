...
static void MessageBannerPopUp(void)
{
    ...
    if (SpriteUtilHasCurrentAnimationEnded())
    {
        ...
        else
        {
            ...
            if (msg == MESSAGE_DUMMY && gCurrentRandoMessage.data != NULL)
                gCurrentSprite.MESSAGE_BANNER_TIMER = RandoGetItemMessageTime();
            else
                gCurrentSprite.MESSAGE_BANNER_TIMER = CONVERT_SECONDS(1) + TWO_THIRD_SECOND;
...
static void MessageBannerRemovalAnimation(void)
{
    ...
    if (SpriteUtilHasCurrentAnimationEnded())
    {
        ...
        // Check replay sounds
        else if (MESSAGE_IS_TANK(msg) || (msg == MESSAGE_DUMMY && gCurrentRandoMessage.soundEffect == MUSIC_GETTING_TANK_JINGLE))
        {
        ...
        else if (gCurrentSprite.MESSAGE_BANNER_NEW_ITEM)
