...
enum MessageId {
    ...
    MESSAGE_POWER_GRIP,
    MESSAGE_PLASMA_BEAM,
    MESSAGE_GRAVITY_SUIT,
    MESSAGE_SPACE_JUMP,
    MESSAGE_NOTHING_ACQUIRED,
    MESSAGE_SPAZER_BEAM,
    MESSAGE_GRAPPLE_BEAM,
    MESSAGE_SPRING_BALL,
    MESSAGE_XRAY_SCOPE,
    MESSAGE_RESERVE_TANK,
    MESSAGE_WALL_JUMP,
    MESSAGE_POWER_BEAM,
    MESSAGE_SPIDER_BALL,
    MESSAGE_DYNAMIC_ITEM,
    MESSAGE_DYNAMIC_ITEM_MAJOR,
    MESSAGE_DYNAMIC_ITEM_UNKNOWN,
    MESSAGE_SAVE_PROMPT,
